...
public class AstJSONValueA extends AstNode {
	...
	public AstJSONValueA(AstJSONObject JSONObject, AstEmptyObject EmptyObject, AstJSONArray JSONArray, string JSONString, TextSource source, int line, int offset, int endoffset) {
